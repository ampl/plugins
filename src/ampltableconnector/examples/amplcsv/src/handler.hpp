...
"\n"
"overwrite:\n"
"    (OUT only) If the option is used the external table will be completely overwritten. Note that, by\n"
...
"\n"
"alias:\n"
"    Instead of writing the data to a specific .csv file it is possible to define an alias. In\n"
